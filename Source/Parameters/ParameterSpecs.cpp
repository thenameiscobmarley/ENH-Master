...
namespace pad::params
{
    static std::vector<Spec> buildSpecs()
    {
        std::vector<Spec> specs {
            ...
            { id::footstep,   "Footstep Radar In", "IN",      "",  Kind::toggle,     0.0f, 1.0f,   0.0f,  0, 0.0f, { "Out", "In" } },
            ...
            { id::charModelA, "Character A",     "A",     "",   Kind::choice, 0.0f, 8.0f, 3.0f, 0, 0.0f,
              { "Modern Clean", "British Console", "American Console", "Vintage Console", "Tape 15 ips", "Tape 30 ips", "Valve", "Arena", "Cinema" } },
            { id::charModelB, "Character B",     "B",     "",   Kind::choice, 0.0f, 8.0f, 4.0f, 0, 0.0f,
              { "Modern Clean", "British Console", "American Console", "Vintage Console", "Tape 15 ips", "Tape 30 ips", "Valve", "Arena", "Cinema" } },
            { id::charBlend,  "Character Blend", "BLEND", " %", Kind::continuous, 0.0f, 100.0f, 0.0f, 0 },
            { id::charDrive,  "Character Drive", "DRIVE", "",   Kind::continuous, 0.0f, 10.0f, 5.0f, 1 },
            { id::charColour, "Character Colour", "COLOUR", "", Kind::continuous, 0.0f, 10.0f, 5.0f, 1 },
            { id::charActive, "Character In",    "IN",    "",   Kind::toggle, 0.0f, 1.0f, 0.0f, 0, 0.0f, { "Out", "In" } },
            { id::charGrit,   "Character Grit",  "GRIT",  "",   Kind::toggle, 0.0f, 1.0f, 1.0f, 0, 0.0f, { "Clean drive", "Drive + distortion" } },
            { id::abCompare,  "Compare",         "COMPARE", "", Kind::toggle, 0.0f, 1.0f, 0.0f, 0, 0.0f, { "Rack", "Input (level-matched)" } },
            { id::monitorSpeed, "Monitor Speed", "SPEED", "", Kind::continuous, 1.0f, 10.0f, 5.0f, 1, 0.0f, {}, false },
            { id::lbEqIn,       "EQ In",          "IN",     "",    Kind::toggle, 0.0f, 1.0f, 0.0f, 0, 0.0f, { "Out", "In" } },
            { id::lbHpf,        "EQ High-Pass",   "HPF",    "",    Kind::choice, 0.0f, 4.0f, 0.0f, 0, 0.0f, { "Off", "50 Hz", "80 Hz", "160 Hz", "300 Hz" } },
            { id::lbLowFreq,    "EQ Low Freq",    "LOW",    "",    Kind::choice, 0.0f, 3.0f, 1.0f, 0, 0.0f, { "35 Hz", "60 Hz", "110 Hz", "220 Hz" } },
            { id::lbLowGain,    "EQ Low Gain",    "LOW",    " dB", Kind::continuous, -16.0f, 16.0f, 0.0f, 1 },
            { id::lbMidFreq,    "EQ Mid Freq",    "MID",    "",    Kind::choice, 0.0f, 5.0f, 2.0f, 0, 0.0f, { "360 Hz", "700 Hz", "1.6 kHz", "3.2 kHz", "4.8 kHz", "7.2 kHz" } },
            { id::lbMidGain,    "EQ Mid Gain",    "MID",    " dB", Kind::continuous, -18.0f, 18.0f, 0.0f, 1 },
            { id::lbMidHiQ,     "EQ Mid Hi Q",    "HI Q",   "",    Kind::toggle, 0.0f, 1.0f, 0.0f, 0 },
            { id::lbHighGain,   "EQ High Gain",   "HIGH",   " dB", Kind::continuous, -16.0f, 16.0f, 0.0f, 1 },
            { id::lbIron,       "EQ Iron",        "IRON",   "",    Kind::toggle, 0.0f, 1.0f, 0.0f, 0 },
            { id::lbHarshIn,    "De-Harsh In",    "IN",     "",    Kind::toggle, 0.0f, 1.0f, 0.0f, 0, 0.0f, { "Out", "In" } },
            { id::lbHarshAmount, "De-Harsh Amount", "AMOUNT", "",  Kind::continuous, 0.0f, 10.0f, 5.0f, 1 },
            { id::lbHarshFreq,  "De-Harsh Freq",  "FREQ",   "",    Kind::choice, 0.0f, 2.0f, 1.0f, 0, 0.0f, { "2.5 kHz", "4 kHz", "6.5 kHz" } },
            { id::lbHarshSpeed, "De-Harsh Speed", "SPEED",  " ms", Kind::continuous, 10.0f, 200.0f, 30.0f, 0 },
            { id::lbFeedIn,     "Crossfeed In",   "IN",     "",    Kind::toggle, 0.0f, 1.0f, 0.0f, 0, 0.0f, { "Out", "In" } },
            { id::lbFeedAmount, "Crossfeed Amount", "AMOUNT", "",  Kind::continuous, 0.0f, 10.0f, 5.0f, 1 },
