...
The unit ends in an output limiter: instant gain-down above -0.7 dBFS, 80 ms recovery, then a soft
clip. MULTIPLY 3x with STRENGTH 5 on both units lands at 0.92 peak instead of clipping.
